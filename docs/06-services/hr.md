...
| Employee Self-Service Portal | Personal information management, payslip access, benefits enrollment, time-off requests, expense submission, training enrollment, company directory — owned by HCM Service; Platform provides notification and file storage infrastructure |
