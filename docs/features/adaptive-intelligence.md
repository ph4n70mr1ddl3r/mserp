...
| Latency | Time to generate recommendation | < 200ms |
...
- [Report Service](../services/report.md) — ML model serving and analytics
- [NFR: Performance](../planning/nfr.md) — ML inference latency < 500ms
