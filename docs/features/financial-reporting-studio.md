...
| **IFFS Full Set** | Statement of FP, P&L, OCI, Cash Flow, Equity, Notes | Yes (IFRS) | Yes | Annual / Interim | Regulators, Investors |
...
- [Report Service](../services/report.md) — Report builder, analytics, and distribution engine
- [Finance Service](../services/finance.md) — Financial data, consolidation, and period management
