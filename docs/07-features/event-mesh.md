...
- [Architecture Overview](../01-architecture/overview.md) — Event-driven architecture patterns
- [Event Catalog](../04-events/catalog.md) — Complete domain event reference
- [Event-Driven Architecture](../04-events/overview.md) — Event schemas, outbox, saga patterns
- [Integration Service](../06-services/integration.md) — Integration service specification
- [NFR: Performance](../10-planning/nfr.md) — Event processing latency < 100ms
